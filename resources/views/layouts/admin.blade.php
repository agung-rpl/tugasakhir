...
<html lang="en" class="light-style layout-menu-fixed" dir="ltr" data-theme="theme-default"
    data-assets-path="../asss/" data-template="vertical-menu-template-free">
...
<head>
    ...
    <title>Dashboard - AUTO TEKNO BENGKEL</title>
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                <div class="app-brand demo">
                    <a href="index.html" class="app-brand-link">
                        ...
                        <span class="app-brand-text demo menu-text fw-bolder ms-2">AUTO TEKNO</span>
                    </a>
                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-item">
                        ...
                        <ul class="menu-sub">
                            <li class="menu-item">
                                <a href="{{ route ('servicebook') }}" class="menu-link">
                                    <div data-i18n="Without menu">Service Booking</div>
                                </a>
                            </li>
                            <li class="menu-item">
                                <a href="{{ route ('goshow') }}" class="menu-link">
                                    <div data-i18n="Without navbar">Service Go Show</div>
                                </a>
                            </li>
